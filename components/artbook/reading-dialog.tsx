...
export function ReadingDialog({ 
  ...
  const sortedPages = [...artbook.pages].sort((a, b) => a.pageNumber - b.pageNumber);
  const currentPageData = sortedPages.find(p => p.pageNumber === currentPage) || sortedPages[0];
  ...
  }, [isOpen, handlePreviousPage, handleNextPage, handlePageChange, sortedPages.length]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent 
        className="max-w-[95vw] max-h-[95vh] w-[95vw] h-[95vh] p-0 bg-white"
